...
@Schema(description = "Payload to create a payment")
public class PaymentCreateRequest {

    @Schema(description = "FK to Payment Type", example = "1", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private Long paymentTypeId;

    @Schema(example = "PAID", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String status;

    @Schema(example = "2025-01-31T09:15:00.000+00:00", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
